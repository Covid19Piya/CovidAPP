...
class chat extends React.Component {
    ...
    render() {
        ...
        console.log(phone);
        this.fireStoreData = firestore().collection("Patient").doc(phone).collection('Chat');
        this.usersCollectionRef = firestore().collection("Patient").doc(phone).collection('Chat');
